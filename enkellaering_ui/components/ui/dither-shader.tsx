...
export const DitherShader = React.forwardRef<HTMLDivElement, DitherShaderProps>(({
  src,
  gridSize = 4,
  ditherMode = "bayer",
  colorMode = "original",
  ...
  return (
    <div ref={setRefs} className={cn("relative h-full w-full", className)}>
      <canvas
        ref={canvasRef}
...
DitherShader.displayName = "DitherShader";
