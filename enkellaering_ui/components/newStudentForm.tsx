...
export default function NewStudentForm() {
    ...
    <div className="max-w-md rounded-lg w-full mx-auto md:rounded-2xl p-4 md:p-8 shadow-none bg-white dark:bg-black">
      ...
      <form className="my-8 " onSubmit={handleSubmit}>
        ...
        <button disabled={isDisabled===true} className="relative inline-flex h-12 overflow-hidden rounded-full p-[5px] dark:p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
