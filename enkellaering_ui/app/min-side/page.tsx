...
import { useTeachersForStudent } from "@/hooks/use-teachers-for-student";
...
export default function MinSideStudentPage() {
    ...
    const [student, studentLoading] = useStudent()
    const [teachers, teachersLoading] = useTeachersForStudent()
    ...
    if (studentLoading || teachersLoading || !student) {
        return (
